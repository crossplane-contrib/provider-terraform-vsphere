...
PROJECT_NAME := provider-terraform-vsphere
...
IMAGES = provider-terraform-vsphere provider-terraform-vsphere-controller
...
dev: $(KIND) $(KUBECTL)
	...
	@$(INFO) Installing Provider Terraform vSphere CRDs
	@$(KUBECTL) apply -f $(CRD_DIR) -R
	@$(INFO) Starting Provider Terraform vSphere controllers
	@$(GO) run cmd/provider/main.go --debug

dev-clean: $(KIND) $(KUBECTL)
	@$(INFO) Deleting kind cluster
	@$(KIND) delete cluster --name=provider-tf-vsphere-dev
