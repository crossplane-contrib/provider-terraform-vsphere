...
func (e *ctyDecoder) DecodeCty(mr resource.Managed, ctyValue cty.Value, schema *providers.Schema) (resource.Managed, error) {
	...
	return DecodeDpmHostOverride(r, ctyValue)
}

func DecodeDpmHostOverride(prev *DpmHostOverride, ctyValue cty.Value) (resource.Managed, error) {
	valMap := ctyValue.AsValueMap()
	new := prev.DeepCopy()
	DecodeDpmHostOverride_ComputeClusterId(&new.Spec.ForProvider, valMap)
	DecodeDpmHostOverride_DpmAutomationLevel(&new.Spec.ForProvider, valMap)
	DecodeDpmHostOverride_DpmEnabled(&new.Spec.ForProvider, valMap)
	DecodeDpmHostOverride_HostSystemId(&new.Spec.ForProvider, valMap)
