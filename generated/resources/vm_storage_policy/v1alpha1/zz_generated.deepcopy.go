...
func (in *VmStoragePolicyList) DeepCopyInto(out *VmStoragePolicyList) {
	*out = *in
	...
	if in.Items != nil {
		...
		*out = make([]VmStoragePolicy, len(*in))
		for i := range *in {
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *VmStoragePolicyObservation) DeepCopyInto(out *VmStoragePolicyObservation) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new VmStoragePolicyObservation.
func (in *VmStoragePolicyObservation) DeepCopy() *VmStoragePolicyObservation {
	if in == nil {
		return nil
	}
	out := new(VmStoragePolicyObservation)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *VmStoragePolicyParameters) DeepCopyInto(out *VmStoragePolicyParameters) {
	*out = *in
	if in.TagRules != nil {
		in, out := &in.TagRules, &out.TagRules
		*out = make([]TagRules, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *VmStoragePolicyParameters) DeepCopy() *VmStoragePolicyParameters {
	if in == nil {
		return nil
	}
	out := new(VmStoragePolicyParameters)
	in.DeepCopyInto(out)
	return out
}
...
func (in *VmStoragePolicyStatus) DeepCopy() *VmStoragePolicyStatus {
	if in == nil {
		return nil
	}
	out := new(VmStoragePolicyStatus)
	in.DeepCopyInto(out)
	return out
}
