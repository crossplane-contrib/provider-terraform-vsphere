...
func (e *ctyDecoder) DecodeCty(mr resource.Managed, ctyValue cty.Value, schema *providers.Schema) (resource.Managed, error) {
	...
	return DecodeFolder(r, ctyValue)
}

func DecodeFolder(prev *Folder, ctyValue cty.Value) (resource.Managed, error) {
	valMap := ctyValue.AsValueMap()
	new := prev.DeepCopy()
	DecodeFolder_CustomAttributes(&new.Spec.ForProvider, valMap)
	DecodeFolder_DatacenterId(&new.Spec.ForProvider, valMap)
	DecodeFolder_Path(&new.Spec.ForProvider, valMap)
	DecodeFolder_Tags(&new.Spec.ForProvider, valMap)
	DecodeFolder_Type(&new.Spec.ForProvider, valMap)
